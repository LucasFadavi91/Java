...
public class MainFiguras {
	...
	public static void main(String[] args) {
		...
		Figura rec2 = new Rectangulo("gris",9,5,4);
		...
		if(((Rectangulo)rec1).esMenor((Rectangulo)rec2))
			System.out.println("El area de "+rec1+" es menor");
			else
				System.out.println("El area de "+rec2+" es menor");
			
			if(((Rectangulo)rec1).esMayor((Rectangulo)rec2))
				System.out.println("El area de "+rec1+" es mayor");
				else
					System.out.println("El area de "+rec2+" es mayor");
