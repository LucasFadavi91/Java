...
public class Main_prueba {
	...
	public static void main(String[] args) {
		...
		Tarjeta tar9 = new Tarjeta("Fadavi Solanilla Lucas", "62466246");
		Tarjeta tar10 = new Tarjeta("Gonzalez Bustos Javier", "62356343");
		Tarjeta tar11 = new Tarjeta("Blazquez Alvarez Jorge", "62346634");
		Tarjeta tar12 = new Tarjeta("Avila Alvarez Sergio", "62346634");
